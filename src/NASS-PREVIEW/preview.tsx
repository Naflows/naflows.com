      ...
      <div className="content">
        ...
        <header className="main-header">
          <div className="socials">
            <a href="https://github.com/Naflows/naflows-auth/" className="social-icon">
              <svg
                width="800px"
                height="800px"
                viewBox="0 0 20 20"
            ...
            <a href="https://discord.gg/5k8aFS9DbK" className="social-icon">
              <svg
                width="800px"
                height="800px"
                viewBox="0 0 24 24"
            ...
            <a href="https://github.com/sponsors/Naflows" className="social-icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24px"
          ...
          <h1 className="title">Coming early 2026</h1>

          <p className="description">
            Open-source solutions for the next generation of software
            development
          </p>
        </header>
      </div>
      <footer>
        #StandAgainstVibeCoding
      </footer>
    </div>
  );
};

export default NASSPreview;
